define(["exports", "require"], function (_exports, _require) {
  ...
  function _templateObject2_34387e30289011e9885753df0b16e612() {
    var data = babelHelpers.taggedTemplateLiteral(["<lazy-element></lazy-element>"]);

    _templateObject2_34387e30289011e9885753df0b16e612 = function _templateObject2_34387e30289011e9885753df0b16e612() {
      return data;
    };
  ...
  function _templateObject_34387e30289011e9885753df0b16e612() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host { display: block; }\n        :host([hidden]) { display: none; }\n      </style>\n\n      <h1>Start LitElement!</h1>\n      <p>", "</p>\n\n      <input name=\"myinput\" id=\"myinput\" \n        type=\"checkbox\"\n        ?checked=\"", "\"\n        @change=\"", "\">\n\n      <label for=\"myinput\">I like pie.</label>\n      \n      ", "\n    "]);

    _templateObject_34387e30289011e9885753df0b16e612 = function _templateObject_34387e30289011e9885753df0b16e612() {
      return data;
    };
  ...
  */
  ...
  function (_LitElement) {
    babelHelpers.inherits(StartLitElement, _LitElement);
    babelHelpers.createClass(StartLitElement, null, [{
      key: "properties",
    ...
    function StartLitElement() {
      var _this13;

      babelHelpers.classCallCheck(this, StartLitElement);
      // Must call superconstructor first.
      _this13 = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(StartLitElement).call(this)); // Initialize properties

      _this13.loadComplete = false;
      _this13.message = 'Hello World from LitElement';
      _this13.pie = false;
      return _this13;
    }
    /**
    ...
    babelHelpers.createClass(StartLitElement, [{
      key: "render",
      value: function render() {
        return html(_templateObject_34387e30289011e9885753df0b16e612(), this.message, this.pie, this.togglePie, this.pie ? html(_templateObject2_34387e30289011e9885753df0b16e612()) : html(_templateObject3_34387e30289011e9885753df0b16e612()));
      }
      /**
      ...
      value: function firstUpdated() {
        this.loadLazy();
        var myInput = this.shadowRoot.getElementById('myinput');
        myInput.focus();
      }
      /**
      ...
      key: "loadLazy",
      value: function () {
        var _loadLazy = babelHelpers.asyncToGenerator(
        /*#__PURE__*/
              ...
              switch (_context2.prev = _context2.next) {
                case 0:
                  ...
                  return _context2.abrupt("return", new Promise(function (res, rej) {
                    return _require.default(['./lazy-element.js'], res, rej);
                  }).then(function (bundle) {
                    return bundle && bundle.$lazyElement || {};
                  }).then(function (LazyElement) {
        ...
        function loadLazy() {
          return _loadLazy.apply(this, arguments);
        }

        return loadLazy;
      }()
    }]);
    return StartLitElement;
  }(LitElement); // Register the element with the browser


  _exports.StartLitElement = StartLitElement;
  customElements.define('start-lit-element', StartLitElement);
  var startLitElement = {
    StartLitElement: StartLitElement
  };
  _exports.$startLitElement = startLitElement;
});